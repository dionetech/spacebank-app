...
export const API_URL = "https://spacebank-api.vercel.app/api/v1"; //"https://spacebank-api-production.up.railway.app/api/v1"; //"http://localhost:6500/api/v1" // "https://api.myspacebank.com/private-api/v1";
