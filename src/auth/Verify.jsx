...
const imageURL =
    "https://res.cloudinary.com/ruthless-labs/image/upload/v1678007848/spacebank/vebkzacxodblspnrgluf.webp";
...
const Verify = () => {
    ...
    const verifyEmail = (e) => {
        ...
        axios({
            ...
            data: {
                email: window.localStorage.getItem("verifyEmail"),
                otp: code,
            },
            headers: {
    ...
    return (
        <>
            ...
            <Header />
            <AuthLayout register={true} imageURL={imageURL}>
                <section className="authLoginSection">
                    <div>
                        <>
                            <h2>Verify email</h2>
                            <p>
                                An OTP has been sent to your email for
                                confirmation
                            </p>
