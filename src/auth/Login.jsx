...
const imageURL =
    "https://res.cloudinary.com/ruthless-labs/image/upload/v1678007810/spacebank/aky7ek2o52kp04eel5zj.webp";
...
const Login = ({ setToken }) => {
    ...
    const loginUser = (e) => {
        ...
        const navigatorInst = window.navigator;

        const deviceInfo = {
            userAgent: navigatorInst.userAgent,
            productSub: navigatorInst.productSub,
        };
                    ...
                    <div>
                        {currentDiv === "qrcode" ? (
                            <>
                                ...
                                <p>
                                    Scan this code with the mobile app to log in
                                    instantly
                                </p>
                                ...
                                <div className="buttonDiv">
                                    <button
                                        onClick={() =>
                                            setCurrentDiv("emailandnumber")
                                        }
                                    >
                                        <MdOutlineLaptopWindows /> Log in with
