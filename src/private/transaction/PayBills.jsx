...
const PayBills = ({ activeUser, token, removeToken, reloadUser }) => {
    ...
    const [networkIcon, setNetworkIcon] = useState("https://bingpay.ng/assets/services/0a966271f6.jpg");
    ...
    const payBill = (e) => {
        e.preventDefault();
        setProcessing(true);
        console.log(service, "27100098246", packageData.variation_code, String(parseInt(amount)));
                                            ...
                                            <div className="form-group">
                                                ...
                                                >
                                                {
                                                    packageList.map((singlePackage) => {
                                                        return (
                                                            <option key={singlePackage.variation_code} value={singlePackage.variation_code}>{singlePackage.name}</option>
                                                        )
                                                    })
                                                }
                                                </select>
